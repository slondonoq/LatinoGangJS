...
const BinaryOperator = React.lazy(() => import('@components/operators/BinaryOperator'));
const OperationAssignBlock = React.lazy(() => import('@components/variables/OperationAssignBlock'));
const IncrementDecrement = React.lazy(() => import('@components/operators/IncrementDecrement'));
const Negation = React.lazy(() => import('@components/operators/Negation'));
const Anumero = React.lazy(() => import('@components/funciones_builtin/Anumero'));
const Acadena = React.lazy(() => import('@components/funciones_builtin/Acadena'));
const Alogico = React.lazy(() => import('@components/funciones_builtin/Alogico'));
const Imprimirf = React.lazy(() => import('@components/funciones_builtin/Imprimirf'));
const Imprimir = React.lazy(() => import('@components/funciones_builtin/Imprimir'));
const Escribir = React.lazy(() => import('@components/funciones_builtin/Escribir'));
...
const Limpiar = React.lazy(() => import('@components/funciones_builtin/Limpiar'));
const CondIf = React.lazy(() => import('@components/conditionals/CondIf'));
const CondElseIf = React.lazy(() => import('@components/conditionals/CondElseIf'));
const CondElse = React.lazy(() => import('@components/conditionals/CondElse'));
const CondSwitch = React.lazy(() => import('@components/conditionals/CondSwitch'));
const CondCase = React.lazy(() => import('@components/conditionals/CondCase'));
const CondDefecto = React.lazy(() => import('@components/conditionals/CondDefecto'));
...
const ForRangeBlock = React.lazy(() => import('@components/iterators/ForRangeBlock'));
...
const DoWhileBlock = React.lazy(() => import('@components/iterators/DoWhileBlock'));
const FunctionBlock = React.lazy(() => import('@components/functions/FunctionBlock'));
const AnonymousFunBlock = React.lazy(() => import('@components/functions/AnonymousFunBlock'));
const ReturnBlock = React.lazy(() => import('@components/functions/ReturnBlock'));
